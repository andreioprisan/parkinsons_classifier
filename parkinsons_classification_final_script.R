...
#selection of "strong predictors": any variable with a corr coeff lower than 0.2 (wrt category) is discarded (the lowest qualifying variable was also discarded bc of interpretability reasons)
